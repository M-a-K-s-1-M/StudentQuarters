        ...
        <YMaps query={{ apikey: '9f8f472c-08bd-4dbb-8ecb-aeb1629d15e7' }}>
            <section className='map-main container'>
                ...
                >
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Студенческое общежитие №7 - общежитие для студентов, находится по адресу ул. Комитерна, д. 3.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        geometry={[56.837939463654294, 60.6592777288635]}
                        properties={{
                            balloonContentBody: `
                            <div class="mark-container">
                              <h3>Общежитие №8</h3>
                              <img src="../../../../public/dormitory8.jpg" alt="Фото места"/>
                              <p>Студенческое общежитие №8 - общежитие для студентов, находится по адресу ул. Комсомольская, д. 70.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Студенческое общежитие №9 - общежитие для студентов, находится по адресу ул. Фонвизина, 8.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Студенческое общежитие №10 находится по адресу ул. Фонвизина, 8.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Студенческое общежитие №10 находится по адресу ул. Коминтерна, д. 5.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Студенческое общежитие №12 расположено по адресу ул. Фонвизина, д. 4.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Студенческое общежитие №14 - общежитие для студентов, находится по адресу ул. Комитерна, д. 1а.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Студенческое общежитие №15 - общежитие для студентов, находится по адресу ул. Коминтерна, д.11.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Студенческое общежитие №16 - общежитие для студентов, находится по адресу ул. Малышева, д. 127а.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Общежитие № 17, расположено по адресу ул. Агрономическая, д. 37.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Общежитие в НВК №1, расположено по адресу ул. 100 летия Уральского университета, д. 6.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
                    ...
                    <Placemark
                        ...
                        properties={{
                            ...
                            <div class="mark-container">
                              ...
                              <p>Общежитие в НВК №2, расположено по адресу ул. 100 летия Уральского университета, д. 6/2.</p>
                            </div>
                              `,
                        }}
                        modules={['geoObject.addon.balloon']}
